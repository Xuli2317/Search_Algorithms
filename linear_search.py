...
# Create a window
window = pyglet.window.Window(width=900, height=200, caption='Linear Search Visualization')
batch = pyglet.graphics.Batch()

# Generate a list with random numbers ensuring 13 is included
numbers = random.sample(list(range(1, 13)) + list(range(14, 100)), 19) + [13]
